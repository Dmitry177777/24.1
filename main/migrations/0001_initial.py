    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_name', models.CharField(default='название', max_length=150, unique=True, verbose_name='название урока')),
                ...
                ('lesson_link', models.CharField(default='', max_length=150, unique=True, verbose_name='ссылка на видео')),
            ],
            options={
